 ...
 * @Author: littletree
 * @CreateDate: 2022/7/19/019 16:57
 */
public class RelationBean implements Serializable {
    ...
    private double trueJD;//真正的角度
    private int relation;//当前是 第几度关系
    private ArrayList<AtmanRelation> atmanRelations;

    public RelationBean(int circle, int numberNex, int x1, int y1, double trueJD, int relation, ArrayList<AtmanRelation> atmanRelations) {
        this.circle = circle;
    ...
    public double getTrueJD() {
        return trueJD;
    }

    public void setTrueJD(double trueJD) {
        this.trueJD = trueJD;
    }
